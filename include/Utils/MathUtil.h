...
public:
    ...
    static double errorRatio(const vector<PqItemSeries *> &approx, const vector<PqItemSeries *> &exact, int k);

    static double tightness(const vector<PqItemSeries *> &approx, const vector<PqItemSeries *> &exact, int k);
